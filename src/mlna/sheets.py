...
SAMPLE_SPREADSHEET_ID = "1sgC_mWYv8YVISnJIfU5oyCFpDt-9yO63ztJT1VbWGqM"
SAMPLE_RANGE_NAME = "Form Responses 1!A2:V"
...
def main():
    ...
    response = requests.get("https://www.when2meet.com/?31478378-ueBAy&csv")
